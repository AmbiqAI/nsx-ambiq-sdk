...
//!
//! @addtogroup info_atomiq110 INFO Functionality
...
// #### INTERNAL BEGIN ####
#warning TODO FIXME am_hal_info.h Temporary workarounds until INFO definitions catch up with 'RRAM' naming
// #### INTERNAL END ####
#define AM_HAL_INFO_INFOSPACE_RRAM_INFO1    AM_HAL_INFO_INFOSPACE_RRAM_INFO1
...
typedef enum
{
    ...
    AM_HAL_INFO_INFOSPACE_OTP_INFO0,        // INFO0 from OTP (regardless of current selection)
    AM_HAL_INFO_INFOSPACE_OTP_INFO1,        // INFO1 from OTP (regardless of current selection)
    AM_HAL_INFO_INFOSPACE_RRAM_INFO0,       // INFO0 from RRAM (regardless of current selection)
    AM_HAL_INFO_INFOSPACE_RRAM_INFO1,       // INFO1 from RRAM (regardless of current selection)
...
//*****************************************************************************
//
//! @brief Atomiq110 INFO0 signature values.
//
//*****************************************************************************
...
//! the 'OTP' or 'RRAM' version is used as the field extractions are the same.
//
//*****************************************************************************
...
//!     - For the "OTP" or "RRAM" types, the user is expected to supply
...
//! of INFO0 (OTP or RRAM) is determined via
...
//! of INFO1 (OTP or RRAM) is determined via
...
//!     AM_HAL_INFO_INFOSPACE_OTP_INFO0         // INFO0 from OTP  (regardless of current selection)
//!     AM_HAL_INFO_INFOSPACE_RRAM_INFO0        // INFO0 from RRAM (regardless of current selection)
//! @param ui32InfoKey - The programming key, AM_HAL_RRAM_INFO_KEY.
