...
//!
//! @addtogroup gpio_at110 GPIO - General Purpose Input Output
...
// #### INTERNAL BEGIN ####
#warning TODO FIXME Update (and remove INTERNAL) this GPIO documentation.
//
...
//!       previous Ambiq devices were handled in the HAL).
//!
