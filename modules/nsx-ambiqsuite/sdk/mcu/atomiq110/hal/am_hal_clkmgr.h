...
//
//! Frequency range for PLLVCO
//
#define AM_HAL_CLKMGR_MIN_PLLVCO_FREQ_HZ     (500000000UL)
#define AM_HAL_CLKMGR_MAX_PLLVCO_FREQ_HZ     (1000000000UL)

//
//! Frequency range for MEMPLL
//
#define AM_HAL_CLKMGR_NOM_MEMPLL_FREQ_HZ     (500000000UL)
#define AM_HAL_CLKMGR_MIN_MEMPLL_FREQ_HZ     (500000000UL)
#define AM_HAL_CLKMGR_MAX_MEMPLL_FREQ_HZ     (500000000UL)
...
//
//TODO: List of clock users to be finalized
typedef enum
{
    ...
    AM_HAL_CLKMGR_USER_ID_IOM8,
    AM_HAL_CLKMGR_USER_ID_IOM9,
    AM_HAL_CLKMGR_USER_ID_IOM10,
    AM_HAL_CLKMGR_USER_ID_IOM11,
    AM_HAL_CLKMGR_USER_ID_UART0,
    AM_HAL_CLKMGR_USER_ID_UART1,
    AM_HAL_CLKMGR_USER_ID_UART2,
    AM_HAL_CLKMGR_USER_ID_UART3,
    AM_HAL_CLKMGR_USER_ID_UART4,
    AM_HAL_CLKMGR_USER_ID_UART5,
    AM_HAL_CLKMGR_USER_ID_ADC,
    AM_HAL_CLKMGR_USER_ID_XSPI0,
    AM_HAL_CLKMGR_USER_ID_XSPI1,
    AM_HAL_CLKMGR_USER_ID_XSPI_S0,
    ...
    AM_HAL_CLKMGR_USER_ID_EMMC,
    AM_HAL_CLKMGR_USER_ID_USB,
    AM_HAL_CLKMGR_USER_ID_OTP,
    AM_HAL_CLKMGR_USER_ID_PDM0,
    AM_HAL_CLKMGR_USER_ID_PDM1,
    AM_HAL_CLKMGR_USER_ID_PDM2,
    AM_HAL_CLKMGR_USER_ID_PDM3,
    AM_HAL_CLKMGR_USER_ID_I2S0,
    AM_HAL_CLKMGR_USER_ID_I2S1,
    AM_HAL_CLKMGR_USER_ID_I2S2,
    AM_HAL_CLKMGR_USER_ID_I3C0,
    AM_HAL_CLKMGR_USER_ID_I3C1,
    AM_HAL_CLKMGR_USER_ID_I3C2,
    AM_HAL_CLKMGR_USER_ID_WDT,
    AM_HAL_CLKMGR_USER_ID_SEC_WDT,
    AM_HAL_CLKMGR_USER_ID_RTC,
    AM_HAL_CLKMGR_USER_ID_SEC_RTC,
    ...
    AM_HAL_CLKMGR_USER_ID_SEC_TIMER0,
    AM_HAL_CLKMGR_USER_ID_SEC_TIMER1,
    AM_HAL_CLKMGR_USER_ID_SEC_TIMER2,
    AM_HAL_CLKMGR_USER_ID_SEC_TIMER3,
    AM_HAL_CLKMGR_USER_ID_STIMER,
    AM_HAL_CLKMGR_USER_ID_SEC_STIMER,
    AM_HAL_CLKMGR_USER_ID_CLKOUT,
    AM_HAL_CLKMGR_USER_ID_MCLK,
    AM_HAL_CLKMGR_USER_ID_HFRC,
    AM_HAL_CLKMGR_USER_ID_HFRC2,
    AM_HAL_CLKMGR_USER_ID_MFRC,
    AM_HAL_CLKMGR_USER_ID_PLLVCO,
    AM_HAL_CLKMGR_USER_ID_SYS_CLK0,
    AM_HAL_CLKMGR_USER_ID_SYS_CLK1,
    AM_HAL_CLKMGR_USER_ID_SYS_CLK2,
    AM_HAL_CLKMGR_USER_ID_SYS_CLK3,
    AM_HAL_CLKMGR_USER_ID_SYS_CLK4,
    AM_HAL_CLKMGR_USER_ID_MEMPLL,
    AM_HAL_CLKMGR_USER_ID_CPU,
    AM_HAL_CLKMGR_USER_ID_CPU_CLK_SW,
    AM_HAL_CLKMGR_USER_ID_DME0,
    AM_HAL_CLKMGR_USER_ID_NPU,
...
typedef enum
{
    ...
    AM_HAL_CLKMGR_CLK_ID_SYS_CLK0,
    AM_HAL_CLKMGR_CLK_ID_SYS_CLK1,
    AM_HAL_CLKMGR_CLK_ID_SYS_CLK2,
    AM_HAL_CLKMGR_CLK_ID_SYS_CLK3,
    AM_HAL_CLKMGR_CLK_ID_SYS_CLK4,
    AM_HAL_CLKMGR_CLK_ID_MEMPLL,
    AM_HAL_CLKMGR_CLK_ID_PLLPOSTDIV,
    AM_HAL_CLKMGR_CLK_ID_MAX = AM_HAL_CLKMGR_CLK_ID_PLLPOSTDIV,
    // TODO: PLLPOSTDIV is to be removed
    // after removal, AM_HAL_CLKMGR_CLK_ID_MAX shall be
    // AM_HAL_CLKMGR_CLK_ID_MEMPLL + 1
...
typedef enum
{
    ...
    // Set SYPLL FREF priority
    AM_HAL_CLKMGR_SYSPLL_FREF_PRIORITY_SET,

    // Set MEMPLL FREF priority
    AM_HAL_CLKMGR_MEMPLL_FREF_PRIORITY_SET,

    // Set SYSPLL emphasis mode
    AM_HAL_CLKMGR_SYSPLL_EMPHASIS_SET,

    // Set MEMPLL emphasis mode
    AM_HAL_CLKMGR_MEMPLL_EMPHASIS_SET,
...
// #### INTERNAL BEGIN ####
//
// CLKMGR XTALHS_MBOX test mode enum
//
typedef enum
{
    // Test Mode disabled
    AM_HAL_CLKMGR_TEST_XTALHS_MBOX_DISABLE,
    // Test Mode enabled, simulate response received
    AM_HAL_CLKMGR_TEST_XTALHS_MBOX_ALWAYS_RESP,
    // Test Mode enabled, simulate response never received
    AM_HAL_CLKMGR_TEST_XTALHS_MBOX_NEVER_RESP,
} am_hal_clkmgr_xtalhs_mbox_testmode_t;
// #### INTERNAL END ####

//
//! HFRC clock supported clock rates
//
#define AM_HAL_CLKMGR_HFRC_FREQ_FREE_RUN_APPROX_500MHZ   (0U)
...
typedef union
{
    ...
    // For MEMPLL configuration
    am_hal_syspll_config_t mempll;
...
//!                     The struct is only written when the returned frequency
//!                     (*pui32RequestedClk) is non-zero. For SYS_CLKx clocks,
//!                     no config struct is returned (frequency only). When the
//!                     clock is not configured or config was invalidated,
//!                     *pui32RequestedClk is 0 and psClockCfg is not written.
//!
//! @return status - Status for the operation, as defined in am_hal_status_e
//
//*****************************************************************************
...
//*****************************************************************************
//
//! @brief Set Clock Manager Board Information Configuration
//!
...
//*****************************************************************************
//
//! @brief Get Clock Manager Board Information Configuration
//!
