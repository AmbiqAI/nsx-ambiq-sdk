...
//!
//! @addtogroup sdhc_at110 SDHC host controller
...
#define SDHCn(n)                     ((SDIO_Type*)(SDIO0_BASE + (n * (EMMC_BASE - SDIO0_BASE))))
...
//! @param pSdhcStateHandle -SDHC state handle.
//!
...
//!
//! This function updates pHost related settings by checking the capabilities of underlying
...
//! @param pHandle      - handle for the interface.
//!
//! This function detects whether a card is present in the slot.
//!
...
//*****************************************************************************
//
//! @brief SDHC sets the SDIO bus IO voltage
//!
//! @param pHandle      - handle for the interface.
...
//!
//! This function sets the bus voltage needed to communicate with the card.
//!
//! @return status      - generic or interface specific status.
//
//*****************************************************************************
...
//!
//! This function sets the bus width needed to communicate with the card.
//!
//! @return status      - generic or interface specific status.
//
//*****************************************************************************
...
//!
//! This function sets the bus clock speed needed to communicate with the card.
//!
//! @return status      - generic or interface specific status.
//
//*****************************************************************************
...
//*****************************************************************************
//
//! @brief SDHC DMA buffer
//!
//! @param pHandle          - handle for the interface.
//! @param pAdmaDescTable   - Set ADMA descriptor table
//!
//! @return status          - generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_hal_sdhc_set_adma_desc_table(void *pHandle, void *pAdmaDescTable);
...
//! transmitted or received. if this command is using asynchronous transfer mode, it will return immediately
...
//
//*****************************************************************************
extern uint32_t am_hal_sdhc_execute_cmd(void *pHandle,
                                        am_hal_card_cmd_t *pCmd,
...
//! @param bEnabledOnly - TRUE: only report interrupt status for enabled ints.
