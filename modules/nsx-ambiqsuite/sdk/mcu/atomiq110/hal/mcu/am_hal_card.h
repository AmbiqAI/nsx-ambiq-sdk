...
//!
//! @addtogroup card_at110 Card Functionality for SD/MMC/eMMC/SDIO
...
#define HS400_200MHZ_18V   0x40
#define HS400_200MHZ_12V   0x80
...
#define SDIO_CARD_MAX_SPEED_LIMIT  100000000
...
#define MMC_HS200_MAX_SPEED_LIMIT   200000000

//
// Atomiq SDHC speed limitation settings
//
#define SDIO_SUPPORT_HS400_INSTANCE 2
#define LEGACY_SDIO_MAX_SPEED_LIMIT 100000000
#define MMC_HS_MAX_SPEED_LIMIT      50000000
...
//!
//! @param eXferMode    - the default transfer mode, like PIO or ADMA.
//!
...
//!
//! @param pAdmaDescTable - ADMA descriptor table.
//!
...
//*****************************************************************************
//
//! @brief Initialize the eMMC card function
//!
//! @param pCard              - pointer to the card instance.
//!
//! @param pCardHost          - Card host handle.
//!
//! @param pSdhcStateHandle   - SDHC state handle.
//!
//! @param pAdmaDescTable     - ADMA descriptor table.
//!
//! @param pCardHostops       - Card host operation.
//!
//! @param eIndex             - index to the underlying card host instance.
//!
//! @param eXferMode          - the transfer mode, like PIO, ADMA.
//!
//! @param eCardPwrCtrlPolicy - Power Control Policy can be:
//!                             AM_HAL_CARD_PWR_CTRL_NONE
//!                             AM_HAL_CARD_PWR_CTRL_SDHC_OFF
...
//!                             AM_HAL_CARD_PWR_CTRL_SDHC_AND_CARD_OFF
//!
//! @param bReInit            - flag that controlling the reinitialization of the card host.
//!
//! This function init eMMC card only for BootRom.
//!
//! @return status            - generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_hal_bootrom_emmc_init(am_hal_card_t *pCard,
                                         am_hal_card_host_t *pCardHost,
                                         void *pSdhcStateHandle,
                                         void *pAdmaDescTable,
                                         am_hal_card_host_ops_t *pCardHostops,
                                         am_hal_host_inst_index_e eIndex,
                                         am_hal_host_xfer_mode_e eXferMode,
                                         am_hal_card_pwr_ctrl_policy_e eCardPwrCtrlPolicy,
                                         bool bReInit);
// #### INTERNAL END ####
