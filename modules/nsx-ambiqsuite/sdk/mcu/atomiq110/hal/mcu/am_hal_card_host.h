...
//!
//! @brief Functions for interfacing with the SDHC SD/MMC/eMMC/SDIO card host.
//!
//! @addtogroup card_host_at110 Card Host for SD/MMC/eMMC/SDIO
...
//
#define AM_HAL_SDIO_MODULE_NUM (AM_REG_SDIO_NUM_MODULES + AM_REG_EMMC_NUM_MODULES)

typedef enum
{
    AM_HAL_SDHC_CARD_HOST0,
    AM_HAL_SDHC_CARD_HOST1,
    AM_HAL_CARD_HOST_NUM = AM_HAL_SDIO_MODULE_NUM,
...
// #### INTERNAL END ####
    ...
    uint32_t (*set_adma_desc_table)(void *pHandle, void *pAdmaDescTable);
...
//! @param pAdmaDescTable   - set the DMA descriptor table when transfer mode is ADMA.
//!
//! @return status          - generic or interface specific status.
//
//! This function sets the default transfer mode and ADMA descriptor table.
//
//*****************************************************************************
extern uint32_t am_hal_card_host_set_xfer_mode(am_hal_card_host_t *pHost,
                                               am_hal_host_xfer_mode_e eXferMode,
                                               void *pAdmaDescTable);
...
//*****************************************************************************
//
//! @brief Card host operation initialization
//!
//! @param pHost       - a pointer to the card host instance
//!
//! @return status     - generic or interface specific status.
//
//! This function initializes card host operation, like SDHC init/deinit,
//! SDHC execute command, etc.
//!
//*****************************************************************************
extern uint32_t am_hal_card_host_ops_init(am_hal_card_host_t *pHost);
