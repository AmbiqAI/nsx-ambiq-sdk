...
//!
//! @addtogroup mcuctrl4_at110 MCUCTRL - MCU Control
...
#define ATOMIQ110_GE_A0                                                  \
  ((MCUCTRL->CHIPREV  &                                                   \
    (MCUCTRL_CHIPREV_REVMAJ_Msk | MCUCTRL_CHIPREV_REVMIN_Msk)) >=         \
      (_VAL2FLD(MCUCTRL_CHIPREV_REVMAJ, MCUCTRL_CHIPREV_REVMAJ_A) |       \
        _VAL2FLD(MCUCTRL_CHIPREV_REVMIN, MCUCTRL_CHIPREV_REVMIN_REV0)))

#define ATOMIQ110_GT_A0                                                  \
  ((MCUCTRL->CHIPREV  &                                                   \
    (MCUCTRL_CHIPREV_REVMAJ_Msk | MCUCTRL_CHIPREV_REVMIN_Msk)) >          \
      (_VAL2FLD(MCUCTRL_CHIPREV_REVMAJ, MCUCTRL_CHIPREV_REVMAJ_A) |       \
        _VAL2FLD(MCUCTRL_CHIPREV_REVMIN, MCUCTRL_CHIPREV_REVMIN_REV0)))
...
#define ATOMIQ110_A0_TRIMVER1    (ATOMIQ110_A0 && (g_ui32TrimVer == A0_TRIMVER_1))
#define ATOMIQ110_A0_GE_TRIMVER1 (ATOMIQ110_A0 && (g_ui32TrimVer >= A0_TRIMVER_1))
#define ATOMIQ110_A0_LE_TRIMVER1 (ATOMIQ110_A0 && (g_ui32TrimVer <= A0_TRIMVER_1))
...
#define AM_HAL_MCUCTRL_CHIPPN_NV_SIZE_N     (_FLD2VAL(MCUCTRL_CHIPPN_RRAMSIZE, 0xFFFFFFFF) + 1)
...
#define AM_HAL_MCUCTRL_SKU_ITCM_SIZE_N      1

#define AM_HAL_MCUCTRL_SKU_DTCM_SIZE_N      (_FLD2VAL(MCUCTRL_SKU_SKUDTCM, 0xFFFFFFFF) + 1)
#define AM_HAL_MCUCTRL_SKU_SSRAM_SIZE_N     (_FLD2VAL(MCUCTRL_SKU_SKUSRAMSIZE, 0xFFFFFFFF) + 1)
#define AM_HAL_MCUCTRL_SKU_RRAM_SIZE_N      (_FLD2VAL(MCUCTRL_SKU_SKURRAMSIZE, 0xFFFFFFFF) + 1)
...
typedef enum
{
    AM_HAL_MCUCTRL_ITCM_NONE = 0,
    AM_HAL_MCUCTRL_ITCM_32K  = 32,
    AM_HAL_MCUCTRL_ITCM_128K = 128,
    AM_HAL_MCUCTRL_ITCM_256K = 256,
} am_hal_mcuctrl_itcm_e;

#define AM_HAL_MCUCTRL_ITCM_MAX    AM_HAL_MCUCTRL_ITCM_256K

typedef enum
{
    AM_HAL_MCUCTRL_DTCM_128K,
    AM_HAL_MCUCTRL_DTCM_256K,
    AM_HAL_MCUCTRL_DTCM_512K,
} am_hal_mcuctrl_dtcm_e;

#define AM_HAL_MCUCTRL_DTCM_MAX    AM_HAL_MCUCTRL_DTCM_512K
...
typedef enum
{
    AM_HAL_MCUCTRL_RRAM_2M,
    AM_HAL_MCUCTRL_RRAM_4M,
} am_hal_mcuctrl_rram_e;

#define AM_HAL_MCUCTRL_RRAM_MAX     AM_HAL_MCUCTRL_RRAM_4M
...
typedef struct
{
    ...
    am_hal_mcuctrl_rram_e       eRRAMSize;          // RRAM Size
    bool                        bDISP;              // DISP
