...
//!
//! @addtogroup ios_at110 IOS - IO Slave (SPI)
...
//! physical parameters of the SPI slave module.
//!
//
//*****************************************************************************
...
typedef struct
{
    ...
    //! either directly through the Atomiq CPU, or over the SPI bus. The
    ...
    //! read/write accessible to the Atomiq CPU, but read-only over the SPI
    ...
    //! allocated to a FIFO. This section is accessible by the Atomiq CPU
    //! through the FIFO control registers, and accessible on the SPI bus
    ...
    //! can only be accessed by the Atomiq CPU. This space will not interact
    //! with the SPI bus at all, and may be used as general-purpose memory.
