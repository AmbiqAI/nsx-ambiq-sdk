...
//!
//! @addtogroup uart_at110 UART Functionality
...
//
//*****************************************************************************
#define UARTn(n)    ((UART0_Type*)AM_REG_UARTn(n))
...
typedef enum
{
    AM_HAL_UART_CLOCK_SRC_HFRC2   = CRM_UART0HFCRM_UART0HFCLKSEL_HFRC2_div1_div1,
    AM_HAL_UART_CLOCK_SRC_XTAL    = CRM_UART0HFCRM_UART0HFCLKSEL_XTAL_HS,
    AM_HAL_UART_CLOCK_SRC_EXTREF  = CRM_UART0HFCRM_UART0HFCLKSEL_EXTREFCLK,
