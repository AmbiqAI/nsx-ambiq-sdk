...
// #### INTERNAL BEGIN ####
#define AM_REG_CTIMER_SDEBUG_O                       0x0000013C
#define AM_REG_CTIMER_DBGRO_O                        0x00000140
// #### INTERNAL END ####
...
//*****************************************************************************
//
// CTIMER_SDEBUG - Debug Register
//
//*****************************************************************************
// The designer should wire in interest read only observability bits here.
#define AM_REG_CTIMER_SDEBUG_FSM_RO_S                0
#define AM_REG_CTIMER_SDEBUG_FSM_RO_M                0x000000FF
#define AM_REG_CTIMER_SDEBUG_FSM_RO(n)               (((uint32_t)(n) << 0) & 0x000000FF)

// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
//*****************************************************************************
//
// CTIMER_DBGRO - Debug Reasd Only Register
//
//*****************************************************************************
// Always read back the fixed value of 0xc001d00d to add in validation of the
// block and to test the bus connections to the block. Subsequent version of
// this block will read a different 32-bit pattern
#define AM_REG_CTIMER_DBGRO_VALUE_S                  0
#define AM_REG_CTIMER_DBGRO_VALUE_M                  0xFFFFFFFF
#define AM_REG_CTIMER_DBGRO_VALUE(n)                 (((uint32_t)(n) << 0) & 0xFFFFFFFF)
