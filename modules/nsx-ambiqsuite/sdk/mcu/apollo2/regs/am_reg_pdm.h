...
// #### INTERNAL BEGIN ####
#define AM_REG_PDM_PDAT_O                            0x00000018
#define AM_REG_PDM_PVAL_O                            0x0000001C
// #### INTERNAL END ####
...
#define AM_REG_PDM_PDAT_PCMRIGHT_S                   16
#define AM_REG_PDM_PDAT_PCMRIGHT_M                   0xFFFF0000
#define AM_REG_PDM_PDAT_PCMRIGHT(n)                  (((uint32_t)(n) << 16) & 0xFFFF0000)

// PCM left channel data.
#define AM_REG_PDM_PDAT_PCMLEFT_S                    0
#define AM_REG_PDM_PDAT_PCMLEFT_M                    0x0000FFFF
#define AM_REG_PDM_PDAT_PCMLEFT(n)                   (((uint32_t)(n) << 0) & 0x0000FFFF)

// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
//*****************************************************************************
//
// PDM_PVAL - PCM Data Available
//
//*****************************************************************************
// PCM data available.
#define AM_REG_PDM_PVAL_PCMVALID_S                   0
#define AM_REG_PDM_PVAL_PCMVALID_M                   0x00000001
#define AM_REG_PDM_PVAL_PCMVALID(n)                  (((uint32_t)(n) << 0) & 0x00000001)
