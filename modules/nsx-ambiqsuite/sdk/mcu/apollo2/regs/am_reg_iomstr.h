...
// #### INTERNAL BEGIN ####
#define AM_REG_IOMSTR_DBG0_O                         0x00000300
#define AM_REG_IOMSTR_DBG1_O                         0x00000304
// #### INTERNAL END ####
...
//*****************************************************************************
//
#define AM_REG_IOMSTR_DBG0_DBG0_S                    0
#define AM_REG_IOMSTR_DBG0_DBG0_M                    0xFFFFFFFF
#define AM_REG_IOMSTR_DBG0_DBG0(n)                   (((uint32_t)(n) << 0) & 0xFFFFFFFF)
...
//*****************************************************************************
//
#define AM_REG_IOMSTR_DBG1_DBG1_S                    0
#define AM_REG_IOMSTR_DBG1_DBG1_M                    0xFFFFFFFF
#define AM_REG_IOMSTR_DBG1_DBG1(n)                   (((uint32_t)(n) << 0) & 0xFFFFFFFF)
