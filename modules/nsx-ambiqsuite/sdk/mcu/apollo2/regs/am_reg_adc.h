...
// #### INTERNAL BEGIN ####
#define AM_REG_ADC_DBGEN_O                           0x00000100
#define AM_REG_ADC_DBGFIFO_O                         0x00000104
#define AM_REG_ADC_DBGDATAIN_O                       0x00000108
#define AM_REG_ADC_DBGOBSCTRL_O                      0x0000010C
#define AM_REG_ADC_REFBUFCTRL_O                      0x00000110
#define AM_REG_ADC_INBUFCTRL_O                       0x00000114
// #### INTERNAL END ####
...
//*****************************************************************************
//
// ADC_DBGEN - Debug Access Enable
//
//*****************************************************************************
// Enables Debug Register.
#define AM_REG_ADC_DBGEN_DBGDATAEN_S                 1
#define AM_REG_ADC_DBGEN_DBGDATAEN_M                 0x00000002
#define AM_REG_ADC_DBGEN_DBGDATAEN(n)                (((uint32_t)(n) << 1) & 0x00000002)

// Enables Debug Register.
#define AM_REG_ADC_DBGEN_DBGEN_S                     0
#define AM_REG_ADC_DBGEN_DBGEN_M                     0x00000001
#define AM_REG_ADC_DBGEN_DBGEN(n)                    (((uint32_t)(n) << 0) & 0x00000001)

// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
//*****************************************************************************
//
// ADC_DBGFIFO - Debug Fifo
//
//*****************************************************************************
// Write Pointer Value
#define AM_REG_ADC_DBGFIFO_RDPTR_S                   8
#define AM_REG_ADC_DBGFIFO_RDPTR_M                   0x0000FF00
#define AM_REG_ADC_DBGFIFO_RDPTR(n)                  (((uint32_t)(n) << 8) & 0x0000FF00)

// Write Pointer Value
#define AM_REG_ADC_DBGFIFO_WRPTR_S                   0
#define AM_REG_ADC_DBGFIFO_WRPTR_M                   0x000000FF
#define AM_REG_ADC_DBGFIFO_WRPTR(n)                  (((uint32_t)(n) << 0) & 0x000000FF)

// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
//*****************************************************************************
//
// ADC_DBGDATAIN - Test Data In
//
//*****************************************************************************
// Debug Test Data In.
#define AM_REG_ADC_DBGDATAIN_DBGDATA_S               0
#define AM_REG_ADC_DBGDATAIN_DBGDATA_M               0x00003FFF
#define AM_REG_ADC_DBGDATAIN_DBGDATA(n)              (((uint32_t)(n) << 0) & 0x00003FFF)

// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
//*****************************************************************************
//
// ADC_DBGOBSCTRL - Debug Observation Control
//
//*****************************************************************************
// Control Mux Select For Debug Observation Data
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_S              0
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_M              0x00000007
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL(n)             (((uint32_t)(n) << 0) & 0x00000007)
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_CTRS           0x00000000
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_STATE          0x00000001
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_DATAOUT        0x00000002
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_TRIGCLKS       0x00000003
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_TBD4           0x00000004
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_TBD5           0x00000005
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_TBD6           0x00000006
#define AM_REG_ADC_DBGOBSCTRL_OBSCTRL_TBD7           0x00000007

// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
//*****************************************************************************
//
// ADC_REFBUFCTRL - Reference Buffer Control Reg
//
//*****************************************************************************
// Writing a 1 to this register prevents reference buffer from powering up after
// initial power up sequence.
#define AM_REG_ADC_REFBUFCTRL_REFKEEPONLY_S          2
#define AM_REG_ADC_REFBUFCTRL_REFKEEPONLY_M          0x00000004
#define AM_REG_ADC_REFBUFCTRL_REFKEEPONLY(n)         (((uint32_t)(n) << 2) & 0x00000004)

// Writing a 1 to this register forces ADC to sequence through reference buffer
// power-up
#define AM_REG_ADC_REFBUFCTRL_REFBUFFRCPWR_S         1
#define AM_REG_ADC_REFBUFCTRL_REFBUFFRCPWR_M         0x00000002
#define AM_REG_ADC_REFBUFCTRL_REFBUFFRCPWR(n)        (((uint32_t)(n) << 1) & 0x00000002)

// Reference buffer has completed charge cycle.
#define AM_REG_ADC_REFBUFCTRL_REFBUFCHARGED_S        0
#define AM_REG_ADC_REFBUFCTRL_REFBUFCHARGED_M        0x00000001
#define AM_REG_ADC_REFBUFCTRL_REFBUFCHARGED(n)       (((uint32_t)(n) << 0) & 0x00000001)

// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
//*****************************************************************************
//
// ADC_INBUFCTRL - Input Buffer Delay Control
//
//*****************************************************************************
// Sets the delay for Input Buffer On Time prior to conversion start prescaled
// by ADC_CLK / 4 (for 48MHz), ADC_CLK / 3 (for 24MHz)
#define AM_REG_ADC_INBUFCTRL_INBUFDLY_S              0
#define AM_REG_ADC_INBUFCTRL_INBUFDLY_M              0x0000000F
#define AM_REG_ADC_INBUFCTRL_INBUFDLY(n)             (((uint32_t)(n) << 0) & 0x0000000F)
