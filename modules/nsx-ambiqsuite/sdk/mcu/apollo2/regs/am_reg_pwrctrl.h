...
// clear it.
#define AM_REG_PWRCTRL_PWRONSTATUS_SYSTEM_DEEPSLEEP_S 31
#define AM_REG_PWRCTRL_PWRONSTATUS_SYSTEM_DEEPSLEEP_M 0x80000000
#define AM_REG_PWRCTRL_PWRONSTATUS_SYSTEM_DEEPSLEEP(n) (((uint32_t)(n) << 31) & 0x80000000)
...
// it.
#define AM_REG_PWRCTRL_PWRONSTATUS_CORE_DEEPSLEEP_S  30
#define AM_REG_PWRCTRL_PWRONSTATUS_CORE_DEEPSLEEP_M  0x40000000
#define AM_REG_PWRCTRL_PWRONSTATUS_CORE_DEEPSLEEP(n) (((uint32_t)(n) << 30) & 0x40000000)
#endif // USE_DEPRECATED
// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
#ifdef MCU_VALIDATION
...
// clear it.
#define AM_REG_PWRCTRL_PWRONSTATUS_CORE_SLEEPING_S   29
#define AM_REG_PWRCTRL_PWRONSTATUS_CORE_SLEEPING_M   0x20000000
#define AM_REG_PWRCTRL_PWRONSTATUS_CORE_SLEEPING(n)  (((uint32_t)(n) << 29) & 0x20000000)
#endif // USE_DEPRECATED
// #### INTERNAL END ####
...
// #### INTERNAL BEGIN ####
#ifdef MCU_VALIDATION
// This bit is 1 if power is supplied to power domain PD_MCUL.
#define AM_REG_PWRCTRL_PWRONSTATUS_PD_MCUL_S         0
#define AM_REG_PWRCTRL_PWRONSTATUS_PD_MCUL_M         0x00000001
#define AM_REG_PWRCTRL_PWRONSTATUS_PD_MCUL(n)        (((uint32_t)(n) << 0) & 0x00000001)
#endif // USE_DEPRECATED
// #### INTERNAL END ####
//*****************************************************************************
//
...
// #### INTERNAL BEGIN ####
#ifdef MCU_VALIDATION
// Setting this bit will enable the Core LDO to be in LPMODE during deep sleep
// even when HFRC is enabled.
#define AM_REG_PWRCTRL_MISCOPT_DIS_LDOLPMODE_HFRC_S  1
#define AM_REG_PWRCTRL_MISCOPT_DIS_LDOLPMODE_HFRC_M  0x00000002
#define AM_REG_PWRCTRL_MISCOPT_DIS_LDOLPMODE_HFRC(n) (((uint32_t)(n) << 1) & 0x00000002)
#endif // USE_DEPRECATED
// #### INTERNAL END ####
// #### INTERNAL BEGIN ####
#ifdef MCU_VALIDATION
// Control Bit to mask the ADC_EN in the adc_pwr_down equation.
#define AM_REG_PWRCTRL_MISCOPT_ADC_EN_MASK_S         0
#define AM_REG_PWRCTRL_MISCOPT_ADC_EN_MASK_M         0x00000001
#define AM_REG_PWRCTRL_MISCOPT_ADC_EN_MASK(n)        (((uint32_t)(n) << 0) & 0x00000001)
#endif // USE_DEPRECATED
// #### INTERNAL END ####
