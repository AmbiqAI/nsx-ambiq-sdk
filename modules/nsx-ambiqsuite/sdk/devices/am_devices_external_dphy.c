...
{
    void *pHandle;
    am_hal_iom_config_t stIOMSettings = {0};
    ...
    //
    // The frequency of Camaro and Cayenne images are different with the same configuration.
    // For Cayenne, AM_HAL_IOM_1MHZ is approximately 1.6MHz.
    // For Camaro, AM_HAL_IOM_12MHZ is approximately 1MHz.
    //
    stIOMSettings.ui32ClockFreq = AM_HAL_IOM_12MHZ;
