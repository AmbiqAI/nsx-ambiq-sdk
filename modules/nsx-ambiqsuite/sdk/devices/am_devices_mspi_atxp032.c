...
// #### INTERNAL BEGIN ####
//
// ATXP032_QUAD_CLKON4_MODE_EN is currently only tested for the apollo4p_eb
//
// #### INTERNAL END ####
...
//*****************************************************************************
//
//! @brief Handle am device init flash.
//!
//! Internal helper for the am device init flash operation.
//!
//! @param pHandle - Pointer to the device handle.
//!
//! @return Status code: `AM_DEVICES_MSPI_ATXP032_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_MSPI_ATXP032_STATUS_*`.
//
//*****************************************************************************
static uint32_t
...
//*****************************************************************************
//
//! @brief Handle am device deinit flash.
//!
//! Internal helper for the am device deinit flash operation.
//!
//! @param pHandle - Pointer to the device handle.
//!
//! @return Status code: `AM_DEVICES_MSPI_ATXP032_STATUS_SUCCESS` on success;
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI atxp032 command write.
//!
//! Internal helper for the am devices MSPI atxp032 command write operation.
//!
//! @param pHandle - Pointer to the device handle.
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI atxp032 command read.
//!
//! Internal helper for the am devices MSPI atxp032 command read operation.
//!
//! @param pHandle - Pointer to the device handle.
//! @param ui8Instr - Value for 8 instr.
//! @param bSendAddr - Address value.
...
//*****************************************************************************
//
//! @brief Handle pfnmspi ATXP032 callback.
//!
//! Internal helper for the pfnmspi ATXP032 callback operation.
//!
...
//*****************************************************************************
//
//! @brief Handle MSPI atxp032 DMA read.
//!
//! Internal helper for the MSPI atxp032 DMA read operation.
//!
//! @param pHandle - Pointer to the device handle.
...
//*****************************************************************************
uint32_t
am_devices_mspi_atxp032_read_cb(void *pHandle, uint8_t *pui8RxBuffer,
                                uint32_t ui32ReadAddress,
                                uint32_t ui32NumBytes,
                                am_hal_mspi_callback_t pfnCallback,
                                void *pCallbackCtxt)
...
//*****************************************************************************
uint32_t
am_devices_mspi_atxp032_read_callback(void *pHandle, uint8_t *pui8RxBuffer,
                                      uint32_t ui32ReadAddress,
                                      uint32_t ui32NumBytes)
{
    am_hal_mspi_dma_transfer_t    Transaction;
    ...
    ui32Status = am_hal_mspi_nonblocking_transfer(pFlash->pMspiHandle, &Transaction,
                                                  ...
                                                  pfnMSPI_ATXP032_Callback, (void *)&ui32DMAStatus);
...
//*****************************************************************************
//
//! @brief Handle MSPI atxp032 DMA write.
//!
//! Internal helper for the MSPI atxp032 DMA write operation.
//!
//! @param pHandle - Pointer to the device handle.
...
//*****************************************************************************
//
//! @brief Handle flash verify pattern.
//!
//! Internal helper for the flash verify pattern operation.
//!
...
//!
//! @param pFlashHandle - Pointer to the device handle.
//! @param length - Length/count for length.
//!
//! @return true if the operation succeeds; otherwise false.
//
...
flash_check(void* pFlashHandle, uint32_t length)
{
    ...
    while ( ui32NumberOfBytesLeft )
    {
        ...
        //
        am_devices_mspi_atxp032_echo_with_inversion(pFlashHandle,
...
//*****************************************************************************
//
//! @brief Handle MSPI atxp032 disable XIP.
//!
//! Internal helper for the MSPI atxp032 disable XIP operation.
//!
//! @param pHandle - Pointer to the device handle.
//!
//! @return Status code: `AM_DEVICES_MSPI_ATXP032_STATUS_SUCCESS` on success;
...
//*****************************************************************************
//
//! @brief Count consecutive ones.
//!
//! Internal helper for the count consecutive ones operation.
//!
//! @param pVal - Pointer to val.
//!
...
//*****************************************************************************
//
//! @brief Find mid point.
//!
//! Internal helper for the find mid point operation.
//!
//! @param pVal - Pointer to val.
//!
//! @return Mid point value.
//
//*****************************************************************************
static uint32_t
