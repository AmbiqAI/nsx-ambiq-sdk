...
//*****************************************************************************
//
//! @brief Handle pfnspi PSRAM callback.
//!
//! Internal helper for the pfnspi PSRAM callback operation.
//!
...
//*****************************************************************************
//
//! @brief Handle IOM init cq element.
//!
//! Internal helper for the IOM init cq element operation.
//!
...
//*****************************************************************************
//
//! @brief Create IOM write transaction.
//!
//! Internal helper for the create IOM write transaction operation.
//!
...
// #### INTERNAL BEGIN ####
#if defined(ADJ_CLK)
    uint32_t ui32status = am_hal_iom_configure_clk_tst( pIom->pIomHandle, &pIom->sSpiPsramCfg );
    if ( ui32status )
    {
        return ui32status;
    }
                                  ...
                                  void **ppIomHandle)
{
    ...
    { 0, 0, 0, 0, 0, 0, 0, 0 };
#elif defined(AM_PART_APOLLO330P_510L) || defined(AM_PART_APOLLO340)
    { 0, 0, 0, 0, 0, 0};
...
#if defined(AM_PART_APOLLO4B) || defined(AM_PART_APOLLO4P) || defined(AM_PART_APOLLO4L) || defined(AM_PART_APOLLO5_API) || defined(AM_PART_ATOMIQ110)
...
//! @param pfnCallback
//! @param pCallbackCtxt
//! @return Status code: `AM_DEVICES_SPIPSRAM_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_SPIPSRAM_STATUS_*`.
//
//*****************************************************************************
static uint32_t
...
#elif defined(AM_PART_APOLLO4) || defined(AM_PART_APOLLO4B) || defined(AM_PART_APOLLO4P) || defined(AM_PART_APOLLO4L) || defined(AM_PART_APOLLO5_API) || defined(AM_PART_ATOMIQ110)
            am_hal_delay_us(1);
#else
#warning "Driver is only defined for APOLLO3, APOLLO3P, APOLLO4, APOLLO5 and ATOMIQ110!!!"
#endif
        }
