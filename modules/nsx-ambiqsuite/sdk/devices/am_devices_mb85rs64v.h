...
#ifndef AM_DEVICES_MB85RS64V_H
#define AM_DEVICES_MB85RS64V_H
...
#define AM_DEVICES_MB85RS64V_MAX_DEVICE_NUM    1
...
//! @param pDevConfig     - IOM device cfg
//! @param ppHandle       - Handle for this driver
//! @param ppIomHandle    - Handle for IOM Driver, used by this driver
//!
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_init(uint32_t ui32Module,
                                          am_devices_mb85rs64v_config_t *pDevConfig,
                                          void **ppHandle,
                                          void **ppIomHandle);
...
//!
//! @param pHandle       - Handle for this driver
//!
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_term(void *pHandle);
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_read_id(void *pHandle, uint32_t *pDeviceID);
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_status_get(void *pHandle, uint32_t *pStatus);
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_command_send(void *pHandle, uint32_t ui32Cmd);
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_blocking_write(void *pHandle,
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_nonblocking_write(void *pHandle,
                                                       uint8_t *pui8TxBuffer,
                                                       uint32_t ui32WriteAddress,
                                                       uint32_t ui32NumBytes,
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_nonblocking_write_adv(void *pHandle,
                                                       uint8_t *pui8TxBuffer,
                                                       uint32_t ui32WriteAddress,
                                                       uint32_t ui32NumBytes,
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_blocking_read(void *pHandle,
...
//
//*****************************************************************************
extern uint32_t am_devices_mb85rs64v_nonblocking_read(void *pHandle,
                                                      uint8_t *pui8RxBuffer,
                                                      uint32_t ui32ReadAddress,
                                                      uint32_t ui32NumBytes,
                                                      am_hal_iom_callback_t pfnCallback,
