...
// #### INTERNAL BEGIN ####
//
// On Apollo5a, APBDMA cannot access TCM across 1k boundary.
// On Apollo510 this limit is 4k; So need to limit the cmd buffer to 4k alignment in TCM.
//
// #### INTERNAL END ####
...
//*****************************************************************************
//
//! @brief Handle tma525 read.
//!
//! Internal helper for the tma525 read operation.
//!
//! @param addr - Address value.
//! @param buffer - Data buffer pointer.
//! @param length - Length/count for length.
//!
//! @return Status code: `AM_DEVICES_TMA525_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_TMA525_STATUS_*`.
//
//*****************************************************************************
static uint32_t
...
//*****************************************************************************
//
//! @brief Handle tma525 noblocking read.
//!
//! Internal helper for the tma525 noblocking read operation.
//!
//! @param addr - Address value.
//! @param buffer - Data buffer pointer.
//! @param length - Length/count for length.
//! @param pfnCallback - Callback function for this operation.
...
//*****************************************************************************
//
//! @brief Handle tma525 write.
//!
//! Internal helper for the tma525 write operation.
//!
//! @param addr - Address value.
//! @param buffer - Data buffer pointer.
//! @param length - Length/count for length.
...
//*****************************************************************************
//
//! @brief Handle tma525 write reg.
//!
//! Internal helper for the tma525 write reg operation.
//!
//! @param addr - Address value.
...
//*****************************************************************************
//
//! @brief Handle tma525 read reg.
//!
//! Internal helper for the tma525 read reg operation.
//!
//! @param addr - Address value.
...
//*****************************************************************************
//
//! @brief Handle tma525 write command.
//!
//! Internal helper for the tma525 write command operation.
//!
...
//*****************************************************************************
//
//! @brief Handle tma525 power sequence.
//!
//! Internal helper for the tma525 power sequence operation.
//!
//! @return Status code: `AM_DEVICES_TMA525_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_TMA525_STATUS_*`.
//
...
//*****************************************************************************
//
//! @brief Handle tma525 reg init.
//!
//! Internal helper for the tma525 reg init operation.
//!
//! @return Status code: `AM_DEVICES_TMA525_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_TMA525_STATUS_*`.
//
...
//*****************************************************************************
//
//! @brief Handle tma525 I2C read.
//!
//! Internal helper for the tma525 I2C read operation.
//!
//! @param ui32BusAddress - Address value.
//! @param pBuf - Data buffer pointer.
//! @param size - Length/count for size.
//!
//! @return Status code: `AM_DEVICES_TMA525_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_TMA525_STATUS_*`.
//
...
//*****************************************************************************
//
//! @brief Handle tma525 I2C noblocking read.
//!
//! Internal helper for the tma525 I2C noblocking read operation.
//!
//! @param ui32BusAddress - Address value.
//! @param pBuf - Data buffer pointer.
//! @param size - Length/count for size.
...
//*****************************************************************************
//
//! @brief Handle tma525 I2C write.
//!
//! Internal helper for the tma525 I2C write operation.
//!
//! @param ui32BusAddress - Address value.
//! @param pBuf - Data buffer pointer.
//! @param size - Length/count for size.
...
//*****************************************************************************
//
//! @brief Handle tma525 master xfer.
//!
//! Internal helper for the tma525 master xfer operation.
//!
...
//*****************************************************************************
//
//! @brief Handle tma525 master noblocking xfer.
//!
//! Internal helper for the tma525 master noblocking xfer operation.
//!
//! @param msgs - Pointer to msgs.
//! @param num - Length/count for num.
//! @param pfnCallback - Callback function for this operation.
...
//*****************************************************************************
//
//! @brief Handle tma525 finish init.
//!
//! Internal helper for the tma525 finish init operation.
//
//*****************************************************************************
static void
...
//*****************************************************************************
//
//! @brief Get unaligned le16.
//!
//! Internal helper for the get unaligned le16 operation.
//!
//! @param p - Pointer to p.
//!
//! @return Unaligned le16 value.
//
//*****************************************************************************
static uint16_t
...
//*****************************************************************************
//
//! @brief Handle pfntma READATA callback.
//!
//! Internal helper for the pfntma READATA callback operation.
//!
//! @param pCallbackCtxt - Pointer to callback ctxt.
...
//*****************************************************************************
//
//! @brief Handle pfntma READINFO callback.
//!
//! Internal helper for the pfntma READINFO callback operation.
//!
//! @param pCallbackCtxt - Pointer to callback ctxt.
//! @param status - Status value.
//
...
// #### INTERNAL BEGIN ####
#ifdef ADAPT_ALL_TOUCH_DRIVER_IN_APPLICATION
    else
    {
        extern void *g_chsc5816_IOMHandle;
...
am_devices_tma525_multidrop_iom_init(uint32_t ui32Module, am_hal_iom_config_t *pDevConfig, void **ppHandle, void **ppIomHandle)
{
    ...
    (void)memset(g_CS, 0, sizeof(g_CS));
#ifdef APOLLO3P_EVB_CYGNUS
    g_CS[1] = AM_BSP_IOM1_CS_CHNL;
    g_CS[3] = AM_BSP_IOM3_CS_CHNL;
    g_CS[4] = AM_BSP_IOM4_CS_CHNL;
#endif
