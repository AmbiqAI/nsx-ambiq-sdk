...
//*****************************************************************************
//
//! @brief Handle am devices rm67162 command read.
//!
//! Internal helper for the am devices rm67162 command read operation.
//!
...
//! @param bTurnaround - Boolean flag for b turnaround.
//!
//! @return Status code: `AM_DEVICES_RM67162_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_RM67162_STATUS_*`.
//
//*****************************************************************************
static uint32_t
