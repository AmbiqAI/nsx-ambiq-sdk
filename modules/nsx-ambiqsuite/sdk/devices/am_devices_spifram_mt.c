...
#include "am_devices_spifram_mt.h"
...
//*****************************************************************************
uint32_t
am_devices_spifram_mt_id(uint32_t ui32IOMModule, uint32_t ui32ChipSelect,
                         uint8_t *manufacturerID, uint16_t *productID)
{
    ...
    am_hal_iom_spi_read(ui32IOMModule,
                        ui32ChipSelect,
...
//*****************************************************************************
void
am_devices_spifram_mt_read_mode(uint32_t ui32IOMModule, uint32_t ui32ChipSelect,
                                uint8_t *pui8RxBuffer, uint32_t ui32ReadAddress,
                                ...
                                am_hal_iom_callback_t pfnCallback)
{
    ...
    oper.mode = mode;
    oper.peerInfo.ui32ChipSelect = ui32ChipSelect;
    oper.pfnCallback = 0;
    ...
    while ( ui32BytesRemaining > 0)
    {
        ...
        uint32_t ui32TransferSize = am_devices_spifram_max_transfersize(
            AM_DEVICES_SPIFRAM_WRITE, ui32IOMModule,
            ui32BytesRemaining);
        ...
        //
        am_hal_iom_operate(ui32IOMModule, &oper);
...
//
static uint32_t g_am_devices_spifram_mt_wren = AM_DEVICES_SPIFRAM_WREN;
static uint32_t g_am_devices_spifram_mt_wrdi = AM_DEVICES_SPIFRAM_WRDI;
...
//*****************************************************************************
void
am_devices_spifram_mt_write_mode(uint32_t ui32IOMModule, uint32_t ui32ChipSelect,
                                 uint8_t *pui8TxBuffer, uint32_t ui32WriteAddress,
                                 uint32_t ui32NumBytes, AM_HAL_IOM_MODE_E mode,
                                 am_hal_iom_callback_t pfnCallback)
{
    ...
    while ( ui32BytesRemaining )
    {
        ...
        //
        oper.oper = AM_HAL_IOM_OPER_WRITE;
        oper.pui32Data = &g_am_devices_spifram_mt_wren;
        oper.ui32NumBytes = 1;
        oper.ui32Options = AM_HAL_IOM_RAW;
        am_hal_iom_operate(ui32IOMModule, &oper);
        ...
        //
        oper.oper = AM_HAL_IOM_OPER_WRITE;
        oper.pui32Data = &g_am_devices_spifram_mt_wrdi;
        oper.ui32NumBytes = 1;
        oper.ui32Options = AM_HAL_IOM_RAW;
        //
