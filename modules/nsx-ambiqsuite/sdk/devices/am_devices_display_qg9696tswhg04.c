...
// #### INTERNAL BEGIN ####
//  Notes:
//      - The QG9696TSWHG04 display requires an asserted low CS.  Since the
//        Apollo IOM provides asserted LOW CEs, it can be used directly with
//        this device.
//      - Test points are provided on the MBRD board to allow serial wire debug
...
//        GPIO29 is DISPLAY_CS
//        GPIO31 is DISPLAY_D_C
// #### INTERNAL END ####
...
//! @details The command can be up to 3 bytes
//! (3 bytes is the largest command the display can handle).
//!
...
//*****************************************************************************
//
//!  @breif This function sets the display for horizontal mode with autoincrement.
...
//*****************************************************************************
static void
set_vert_mode(am_devices_display_qg9696tswhg04_t *psDisplayContext)
{
    //
    // Remap to vertical mode.
    //
    send_cmd(QG9696TSWHG04_CMD2B_SET_REMAP, 0x57, 0, 2, psDisplayContext);
...
//
//
//! @brief This function sets the row number.
//!
//! @details This function sets the row number. All subsequently written data
//! will start on the specified row.
//!
//!
//!  @param psDisplayContext    - Pointer to the displey device context structure.
