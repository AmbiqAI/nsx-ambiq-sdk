...
//
// Apollo3 uses am_hal_gpio_state_write / am_hal_gpio_input_read(); earlier
// families use am_hal_gpio_out_bit_* and am_hal_gpio_input_read() bitmask.
// BSP may define AM_APOLLO3_GPIO; default 0 avoids -Wundef when unset.
//
#ifndef AM_APOLLO3_GPIO
#define AM_APOLLO3_GPIO                         0
#endif
...
#error Invalid AM_BSP_EM9304_IOM
    ...
    NVIC_SetPriority(IOMSTR0_IRQn + AM_BSP_EM9404_IOM, AM_IRQ_PRIORITY_DEFAULT);
...
//*****************************************************************************
uint32_t
am_devices_em9304_fullduplex(void *pHandle, uint32_t ui32WriteAddress,
                             ...
                             uint32_t ui32TxNumBytes)
{
    ...
    //
    ui32Status = am_hal_iom_spi_blocking_fullduplex(pIom->pIomHandle,
                                                    &Transaction);
