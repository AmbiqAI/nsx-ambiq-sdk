...
// #### INTERNAL BEGIN ####
//
// DS35X1GA_QUAD_CLKON4_MODE_EN is currently only tested for the apollo4l_eb
//
// #### INTERNAL END ####
...
//*****************************************************************************
//
//! @brief Handle ds35x1ga command addr len.
//!
//! Internal helper for the ds35x1ga command addr len operation.
//!
//! @param cmd - Value for command.
//!
...
#endif
// #### INTERNAL BEGIN ####
// attempt to adapt some of the problematic 4l_eb board

#if defined(apollo4l_eb)
//*****************************************************************************
//
//! @brief Set nand flash WP and hold pin as high level in serial mode
//
//*****************************************************************************
static void
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI ds35x1ga read status.
//!
//! Internal helper for the am devices MSPI ds35x1ga read status operation.
//!
//! @param pHandle - Pointer to the device handle.
//! @param ui8Addr - Address value.
//! @param pu8iData - Data buffer pointer.
//!
//! @return Status code: `AM_DEVICES_MSPI_DS35X1GA_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_MSPI_DS35X1GA_STATUS_*`.
//
//*****************************************************************************
static uint32_t
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI ds35x1ga write status.
//!
//! Internal helper for the am devices MSPI ds35x1ga write status operation.
//!
//! @param pHandle - Pointer to the device handle.
//! @param ui8Data - Data value.
//! @param ui8Addr - Address value.
//! @param pui8Data - Data buffer pointer.
//!
//! @return Status code: `AM_DEVICES_MSPI_DS35X1GA_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_MSPI_DS35X1GA_STATUS_*`.
//
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI ds35x1ga reset.
//!
//! Internal helper for the am devices MSPI ds35x1ga reset operation.
//!
//! @param pHandle - Pointer to the device handle.
//!
//! @return Status code: `AM_DEVICES_MSPI_DS35X1GA_STATUS_SUCCESS` on success;
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI ds35x1ga asize reconfig.
//!
//! Internal helper for the am devices MSPI ds35x1ga asize reconfig operation.
//!
//! @param pHandle - Pointer to the device handle.
//! @param ui8NewLen - Length/count for 8 new len.
//!
//! @return Unsigned result value.
//
//*****************************************************************************
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI device reconfigure.
//!
//! Internal helper for the am devices MSPI device reconfigure operation.
//!
//! @param pHandle - Pointer to the device handle.
//! @param pConfig - Pointer to configuration data.
//!
//! @return Status code: `AM_DEVICES_MSPI_DS35X1GA_STATUS_SUCCESS` on success;
//!         otherwise `AM_DEVICES_MSPI_DS35X1GA_STATUS_*`.
//
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI ds35x1ga enter command mode.
//!
//! Internal helper for the am devices MSPI ds35x1ga enter command mode operation.
//!
//! @param pHandle - Pointer to the device handle.
//!
//! @return Status code: `AM_DEVICES_MSPI_DS35X1GA_STATUS_SUCCESS` on success;
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI ds35x1ga exit command mode.
//!
//! Internal helper for the am devices MSPI ds35x1ga exit command mode operation.
//!
//! @param pHandle - Pointer to the device handle.
//!
//! @return Status code: `AM_DEVICES_MSPI_DS35X1GA_STATUS_SUCCESS` on success;
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI ds35x1ga command write.
//!
//! Internal helper for the am devices MSPI ds35x1ga command write operation.
//!
//! @param pHandle - Pointer to the device handle.
//! @param ui8Instr - Value for 8 instr.
//! @param bSendAddr - Address value.
//! @param ui32Addr - Address value.
...
//*****************************************************************************
//
//! @brief Handle pfnmspi DS35X1GA callback.
//!
//! Internal helper for the pfnmspi DS35X1GA callback operation.
//!
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI ds35x1ga tx enter ad4 mode.
//!
//! Internal helper for the am devices MSPI ds35x1ga tx enter ad4 mode operation.
//!
//! @param pHandle - Pointer to the device handle.
//!
//! @return Status code: `AM_DEVICES_MSPI_DS35X1GA_STATUS_SUCCESS` on success;
...
//!
//! Internal helper for the read from cache operation.
//!
//! @param pHandle - Pointer to the device handle.
//! @param cacheadd - Value for cacheadd.
//! @param dat - Pointer to dat.
//! @param num - Length/count for num.
//!
...
//! @brief Program load.
//!
//! Internal helper for the program load operation.
//!
//! @param pHandle - Pointer to the device handle.
//! @param cacheadd - Value for cacheadd.
//! @param dat - Pointer to dat.
...
//*****************************************************************************
//
//! @brief Handle flash check.
//!
//! Internal helper for the flash check operation.
//!
//! @param flashHandle - Pointer to the device handle.
...
// #### INTERNAL BEGIN ####
        ...
        //
#if defined(AM_PART_APOLLO4) || defined(AM_PART_APOLLO4B)
        am_util_debug_printf("\n Turnaround %d - RXNEG %d = 0x%08X\n", ds35x1ga_sConfigArray[i].ui32Turnaround, ds35x1ga_sConfigArray[i].ui32Rxneg, ui32ResultArray[i]);
#else
        am_util_debug_printf("\n    Setting %d = 0x%08X\n", i, ui32ResultArray[i]);
        am_util_debug_printf(" TxNeg %d, RxNeg %d, RxCap %d, TxDQSDelay %d, Turnaround %d == 0x%08X\n",
                             ds35x1ga_sConfigArray[i].bTxNeg, ds35x1ga_sConfigArray[i].bRxNeg, ds35x1ga_sConfigArray[i].bRxCap,
                             ds35x1ga_sConfigArray[i].ui8TxDQSDelay,
                             ds35x1ga_sConfigArray[i].ui8Turnaround, ui32ResultArray[i]);
#endif
// #### INTERNAL END ####
    }
#if defined(AM_PART_APOLLO4) || defined(AM_PART_APOLLO4B)
