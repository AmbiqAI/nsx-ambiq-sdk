...
uint32_t nsx_emmc_platform_init(nsx_emmc_config_t *cfg) {
     ...
     * (confirmed by searching every emmc_*/sdio_* example source in the
     * AmbiqSuite tree), yet without it, am_hal_card_host_find_card() and
     * every subsequent SDIO command hangs indefinitely on real hardware,
