...
#define AM_HAL_VERSION_MIN      2
#define AM_HAL_VERSION_REV      0
#elif defined(AM_PART_ATOMIQ11X_API)
#define AM_HAL_VERSION_MAJ      6
...
//
// History:
//  06/06/2025  5.1.0  Ready for R5.1.0 code freeze.
//  03/28/2025  5.0.0  Ready for R5.0.0 code freeze.
...
//  04/25/2023  5.0.0  To remain at 5.0.0 until first public release.
