...
//
#if                                         \
  defined(AM_ID_ATOMIQ110)          ||      \
  defined(AM_ID_APOLLO330P_510L)    ||      \
  defined(AM_ID_APOLLO510)          ||      \
  defined(AM_ID_APOLLO4P)
//
...
//
//*****************************************************************************
#define AM_UTIL_MCUCTRL_CHIP_INFO_PARTNUM_ATOMIQ110         0x11000000
...
#define AM_UTIL_ID_ATOMIQ110        0x0400      // Atomiq110
//! @}
