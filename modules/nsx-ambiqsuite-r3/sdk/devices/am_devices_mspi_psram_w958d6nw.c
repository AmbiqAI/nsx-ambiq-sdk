...
//#define W958D6NW_USE_NON_DQS_MODE
// #### INTERNAL BEGIN ####
#endif //defined(APOLLO4_FPGA) || defined(APOLLO5_FPGA)
// #### INTERNAL END ####
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI PSRAM w958d6nw get ilc.
//!
//! Internal helper for the am devices MSPI PSRAM w958d6nw get ilc operation.
//!
//! @param eWLC - Value for e WLC.
//! @param pILC - Pointer to ILC.
//!
...
//*****************************************************************************
//
//! @brief Handle am devices MSPI PSRAM w958d6nw config.
//!
//! Internal helper for the am devices MSPI PSRAM w958d6nw config operation.
//!
