 ...
 *        powered on. If using a power-management configuration, ensure it
 *        keeps shared SRAM enabled.
...
/* Fix: NSX_SRAM_BSS was broken on Apollo510/510B (empty expansion).
 * This provides a working definition for all SoCs. */
#undef NSX_SRAM_BSS
#define NSX_SRAM_BSS      NSX_MEM_SRAM_BSS
