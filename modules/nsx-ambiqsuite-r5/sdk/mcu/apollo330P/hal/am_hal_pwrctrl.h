...
//  uint32_t ui32TRIM_SBR_OTP;              // 60 Apollo330P
// #### INTERNAL END ####
    uint32_t ui32TEMP_CAL_ATE;              // 00
    uint32_t ui32TEMP_CAL_MEASURED;         // 04
    uint32_t ui32TEMP_CAL_ADC_OFFSET;       // 08
// #### INTERNAL BEGIN ####
//  uint32_t ui32CHIPSUBREV;                // 0C Apollo330P
//  uint32_t ui32TRIM_REV;                  // 10
//  uint32_t ui32FT1_GDR1;                  // 14 Apollo330P
//  uint32_t ui32FT2_GDR1;                  // 18 Apollo330P
//  uint32_t ui32LVT_TRIMCODE;              // 1C Apollo330P
//  uint32_t ui32EHVT_TRIMCODE;             // 20 Apollo330P
