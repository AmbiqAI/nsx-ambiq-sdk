...
//  uint32_t ui32TRIM_SBR_OTP;              // 60 Apollo510L
// #### INTERNAL END ####
    uint32_t ui32TEMP_CAL_ATE;              // 00
    uint32_t ui32TEMP_CAL_MEASURED;         // 04
    uint32_t ui32TEMP_CAL_ADC_OFFSET;       // 08
// #### INTERNAL BEGIN ####
//  uint32_t ui32CHIPSUBREV;                // 0C Apollo510L
//  uint32_t ui32TRIM_REV;                  // 10
//  uint32_t ui32FT1_GDR1;                  // 14 Apollo510L
//  uint32_t ui32FT2_GDR1;                  // 18 Apollo510L
//  uint32_t ui32LVT_TRIMCODE;              // 1C Apollo510L
//  uint32_t ui32EHVT_TRIMCODE;             // 20 Apollo510L
