...
//!
// #### INTERNAL BEGIN ####
// FBRDSW-1250 Cayenne testing.
// Apollo510 ADC requires the reference voltage be 1200mV, whereas it is
// specified as 1.19v for all other Ambiq devices. See also the datasheet.
// #### INTERNAL END ####
