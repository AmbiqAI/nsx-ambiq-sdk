...
//! @{
//!
//! @note The following definitions are typically specific to a multibit spi
//! psram device. They should be tailored.
//
//*****************************************************************************
//
...
typedef struct
{
    ...
    union
    {
        uint8_t MR9;                                //Mode register 8

        struct
        {
            uint8_t                 : 3;            //[0..2] Should be '000'
            uint8_t REF_IND         : 1;            //[3..3] Optimize write latency, the default value is 1, should setting to 0
            uint8_t                 : 1;            //[4..4] reserved, default '0'
            uint8_t CMD_MODE        : 1;            //[5..5] Command Mode
            uint8_t                 : 2;            //[6..7] Rsvd, default '00'
        }MR9_b;
    } ;
#endif
