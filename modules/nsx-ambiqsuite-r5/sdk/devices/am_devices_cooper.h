...
#define AM_DEVICES_COOPER_SWCLK               98
// #### INTERNAL BEGIN ####
#define AM_DEVICES_COOPER_DEBUG0_IN_PIN       96 //!< COOPER GPIO15
#define AM_DEVICES_COOPER_DEBUG0_OUT_PIN      49
#define AM_DEVICES_COOPER_DEBUG1_IN_PIN       93 //!< COOPER GPIO1
#define AM_DEVICES_COOPER_DEBUG1_OUT_PIN      48
// #### INTERNAL END ####
...
// #### INTERNAL BEGIN ####
#define AM_DEVICES_COOPER_DEBUG_PIN_ENABLE    0
#define AM_DEVICES_COOPER_STRESS_TEST         0
...
// #### INTERNAL BEGIN ####
    //! Memory write enable
    PARAM_ID_MEM_WRITE_ENABLE           = 0x50,
// #### INTERNAL END ####
...
typedef enum
{
    ...
    // #### INTERNAL BEGIN ####
    // Ambiq Vendor Specific Command set high priority notification/indication handle
    HCI_DBG_SET_HIGH_PRIORITY_NOTIFY_CMD_OPCODE    = 0xFC7C,
    // #### INTERNAL END ####
...
// #### INTERNAL BEGIN ####
#define HCI_VSC_SET_HIGH_PRIO_NOTIFY_CMD_LENGTH        8
// #### INTERNAL END ####
...
// #### INTERNAL BEGIN ####
//! Memory write enable
#define NVDS_PARAMETER_MEM_WRITE_ENABLE PARAM_ID_MEM_WRITE_ENABLE, 0x06, 0x01, 0x01
#if defined APOLLO4_ATE
#define NVDS_PARAMETER_EXT_32K_CLK_SOURCE PARAM_ID_32K_CLK_SOURCE, 0x06, 0x01, 0x00
#else
// #### INTERNAL END ####
//! 32kHz clock source
...
//
//*****************************************************************************
extern uint32_t am_devices_cooper_nonblocking_write(void* pHandle, uint8_t ui8Type, uint32_t* pui32Data, uint32_t ui32NumBytes, am_devices_cooper_callback_t pfnCallback, void* pCallbackCtxt, bool bWaitReady);
//*****************************************************************************
//
//! @brief Read the Cooper status.
//! @param pHandle
//! @param pui32Status
//! @return
//
