...
#ifndef AM_DEVICES_ADAU1777_H
#define AM_DEVICES_ADAU1777_H
...
#define MOD_GAIN1_ALG0_STAGE0_B0_ADDR                  224
#define MOD_GAIN1_ALG1_STAGE0_B0_ADDR                  225
#define MOD_GAIN1_ALG0_STAGE0_B1_ADDR                  256
#define MOD_GAIN1_ALG1_STAGE0_B1_ADDR                  257
#define MOD_GAIN1_ALG0_STAGE0_B2_ADDR                  288
#define MOD_GAIN1_ALG1_STAGE0_B2_ADDR                  289
#define MOD_GAIN1_ALG0_STAGE0_A1_ADDR                  320
#define MOD_GAIN1_ALG1_STAGE0_A1_ADDR                  321
#define MOD_GAIN1_ALG0_STAGE0_A2_ADDR                  352
#define MOD_GAIN1_ALG1_STAGE0_A2_ADDR                  353
...
#define REG_CLK_CONTROL_IC_1_VALUE                0x1
...
#define REG_CORE_IN_MUX_2_3_IC_1_VALUE            0xDC
...
#define REG_DECIM_PWR_MODES_IC_1_VALUE            0xFF
...
#define R16_CORE_IN_MUX_SEL_2_IC_1                0xC    /* 1100b	[3:0] */
#define R16_CORE_IN_MUX_SEL_3_IC_1                0xD    /* 1101b	[7:4] */
...
#define R20_SOUT_SOURCE3_IC_1                     0x6    /* 0110b	[7:4] */
...
#define R21_SOUT_SOURCE5_IC_1                     0x4    /* 0100b	[7:4] */
...
#define R24_ASRC_OUT_SOURCE1_IC_1                 0x5    /* 0101b	[7:4] */
...
#define R25_ASRC_OUT_SOURCE2_IC_1                 0x3    /* 0011b	[3:0] */
...
/* PGA_CONTROL_0 (IC 1) */
#define R35_PGA_GAIN0_IC_1                        0x3F   /* 111111b	[5:0] */
...
/* PGA_CONTROL_1 (IC 1) */
#define R36_PGA_GAIN1_IC_1                        0x3F   /* 111111b	[5:0] */
...
/* SAI_0 (IC 1) */
#define R50_SER_PORT_FS_IC_1                      0x3    /* 0011b	[3:0] */
...
#define R51_BCLK_TDMC_IC_1                        0x1    /* 1b	[6] */
...
#define R66_DEC_0_EN_IC_1                         0x1    /* 1b	[4] */
#define R66_DEC_1_EN_IC_1                         0x1    /* 1b	[5] */
...
typedef enum
{
    AD1777_SAI_SLAVE  = 0x00,
    AD1777_SAI_MASTER = 0x01
} ad1777_sai_ms_mode_t;

typedef enum
{
    AD1777_MAIN_CLK_DISABLED = 0x00,
    AD1777_MAIN_CLK_ENABLED  = 0x01
} ad1777_main_clk_en_t;

typedef enum
{
    AD1777_SAI_I2S  = 0x00,
    AD1777_SAI_TDM2 = 0x01,
    AD1777_SAI_TDM4 = 0x02,
    AD1777_SAI_TDM8 = 0x03
} ad1777_sai_port_mode_t;

typedef enum
{
    AD1777_TDM_I2S      = 0x00,
    AD1777_TDM_LEFT     = 0x01,
    AD1777_RIGHT_24_BIT = 0x02,
    AD1777_RIGHT_16_BIT = 0x03
} ad1777_sdata_fmt_t;

typedef enum
{
    AD1777_CORE_OUTPUT_0  = 0x00,
    AD1777_CORE_OUTPUT_1  = 0x01,
    AD1777_CORE_OUTPUT_2  = 0x02,
    AD1777_CORE_OUTPUT_3  = 0x03,
    AD1777_ADC_0          = 0x04,
    AD1777_ADC_1          = 0x05,
    AD1777_ADC_2          = 0x06,
    AD1777_ADC_3          = 0x07,
    AD1777_SERIAL_INPUT_0 = 0x08,
    AD1777_SERIAL_INPUT_1 = 0x09,
    AD1777_SERIAL_INPUT_2 = 0x0A,
    AD1777_SERIAL_INPUT_3 = 0x0B,
    AD1777_SERIAL_INPUT_4 = 0x0C,
    AD1777_SERIAL_INPUT_5 = 0x0D,
    AD1777_SERIAL_INPUT_6 = 0x0E,
    AD1777_SERIAL_INPUT_7 = 0x0F
} ad1777_asrc_out_source_t;

typedef enum
{
    AD1777_PGA_POWER_DOWN = 0x00,
    AD1777_PGA_POWER_UP   = 0x01
} ad1777_pga_en_t;

typedef enum
{
    AD1777_DAC_UNMUTE = 0x00,
    AD1777_DAC_MUTE   = 0x01
} ad1777_dac_mute_t;

typedef enum
{
    AD1777_MIC_BIAS_DISA = 0x00,
    AD1777_MIC_BIAS_EN   = 0x01
} ad1777_mic_bias_t;

typedef enum
{
    AD1777_50_DUTY_CYCLE = 0x00,
    AD1777_SINGLE_BCLK   = 0x01
} ad1777_lrclk_mode_t;

typedef enum
{
    RESERVED              = 0x00,
    OUTPUT_ASRC_CHANNEL_0 = 0x04,
    OUTPUT_ASRC_CHANNEL_1 = 0x05,
    OUTPUT_ASRC_CHANNEL_2 = 0x06,
    OUTPUT_ASRC_CHANNEL_3 = 0x07,
    SERIAL_INPUT_0        = 0x08,
    SERIAL_INPUT_1        = 0x09,
    SERIAL_INPUT_2        = 0x0A,
    SERIAL_INPUT_3        = 0x0B,
    ...
    SERIAL_INPUT_6        = 0x0E,
    SERIAL_INPUT_7        = 0x0F
} ad1777_sout_source_t;

typedef enum
{
    MONO_AEC = 0x00,
    STEREO   = 0x01
} ad1777_output_mode_t;

typedef enum
{
    AD1777_PGA_UNMUTE = 0x00,
    AD1777_PGA_MUTE   = 0x01
} ad1777_pga_mute_t;

typedef enum
{
    AM_DEVICES_ADAU1777_STATUS_SUCCESS,
    AM_DEVICES_ADAU1777_STATUS_FAIL,
    AM_DEVICES_ADAU1777_STATUS_INVALID_HANDLE,
    AM_DEVICES_ADAU1777_STATUS_IN_USE,
    AM_DEVICES_ADAU1777_STATUS_TIMEOUT,
    AM_DEVICES_ADAU1777_STATUS_OUT_OF_RANGE,
    AM_DEVICES_ADAU1777_STATUS_INVALID_ARG,
    AM_DEVICES_ADAU1777_STATUS_INVALID_OPERATION,
    AM_DEVICES_ADAU1777_STATUS_MEM_ERR,
    AM_DEVICES_ADAU1777_STATUS_HW_ERR,
} am_devices_ADAU1777_status_t;
...
//*****************************************************************************
//
//! @brief Init IOM for the ADAU1777 AMP
//!
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_i2c_init(uint32_t             ui32Module,
                                am_hal_iom_config_t *psIOMSettings);

//*****************************************************************************
//
//! @brief Init the Device ADAU1777 Amplifier.
//!
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_init(uint8_t chip_addr);

//*****************************************************************************
//
//! @brief Deinit IOM for the ADAU1777 Amplifier.
//!
//! @param ui32Module - IOM Module Number.
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_i2c_deinit(uint32_t ui32Module);

//*****************************************************************************
//
//! @brief Deinit the Device ADAU1777 Amplifier.
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_deinit(uint8_t chip_addr);

//*****************************************************************************
//
//! @brief Read data from ADAU1777.
//!
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_i2c_read(uint32_t dev_addr,
                                            uint16_t reg_addr,
                                            uint32_t *p_buf,
                                            uint32_t size);
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_i2c_write(uint32_t dev_addr,
                                             uint16_t reg_addr,
                                             uint32_t *p_buf,
                                             uint32_t size);
...
//*****************************************************************************
//
//! @brief Set ADAU1777 Powerdown State
//!
//! @param chip_addr - Chip I2C device address.
//!
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_power_down(uint8_t chip_addr, bool state);

//*****************************************************************************
//
//! @brief Set ADAU1777 Sample Rate
//!
//! @param chip_addr - Chip I2C device address.
//!
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_sample_rate(uint8_t chip_addr, uint32_t sample_rate);

//*****************************************************************************
//
//! @brief Set the number of bit clock cycles per data channel for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param bclk_cycles - valid value is 32, 16
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_bclk_rate(uint8_t chip_addr, uint32_t bclk_cycles);

//*****************************************************************************
//
//! @brief Set the serial port to master or slave mode for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param mode - valid values are AD1777_SAI_SLAVE, AD1777_SAI_MASTER
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_sai_ms(uint8_t chip_addr, ad1777_sai_ms_mode_t mode);

//*****************************************************************************
//
//! @brief Mute ADAU1777 DAC0 Output, DAC0 is the left channel output
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param value - valid values are AD1777_DAC_UNMUTE, AD1777_DAC_MUTE
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_mute_dac_0(uint8_t chip_addr, ad1777_dac_mute_t value);

//*****************************************************************************
//
//! @brief Mute ADAU1777 DAC1 Output, DAC1 is the right channel output
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param value - valid values are AD1777_DAC_UNMUTE, AD1777_DAC_MUTE
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_mute_dac_1(uint8_t chip_addr, ad1777_dac_mute_t value);

//*****************************************************************************
//
//! @brief Set DAC0 volume for ADAU1777, DAC0 is the left channel output
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param vol - valid values are 0x00 to 0xFF, where 0x00(0dB) is max volume and 0xFF(-95.625dB) is min volume.
//! Each step represents a decrease of -0.375dB.
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_dac_0_volume(uint8_t chip_addr, uint8_t vol);

//*****************************************************************************
//
//! @brief Set DAC1 volume for ADAU1777, DAC1 is the right channel output
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param vol - valid values are 0x00 to 0xFF, where 0x00(0dB) is max volume and 0xFF(-95.625dB) is min volume.
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_dac_1_volume(uint8_t chip_addr, uint8_t vol);

//*****************************************************************************
//
//! @brief Set output asrc0 source for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param source - valid values are AD1777_CORE_OUTPUT_0 to AD1777_SERIAL_INPUT_7
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_asrco_source_0(uint8_t chip_addr, ad1777_asrc_out_source_t source);

//*****************************************************************************
//
//! @brief Set output asrc1 source for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param source - valid values are AD1777_CORE_OUTPUT_0 to AD1777_SERIAL_INPUT_7
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_asrco_source_1(uint8_t chip_addr, ad1777_asrc_out_source_t source);

//*****************************************************************************
//
//! @brief Set output asrc2 source for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param source - valid values are AD1777_CORE_OUTPUT_0 to AD1777_SERIAL_INPUT_7
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_asrco_source_2(uint8_t chip_addr, ad1777_asrc_out_source_t source);

//*****************************************************************************
//
//! @brief Set output asrc3 source for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param source - valid values are AD1777_CORE_OUTPUT_0 to AD1777_SERIAL_INPUT_7
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_asrco_source_3(uint8_t chip_addr, ad1777_asrc_out_source_t source);

//*****************************************************************************
//
//! @brief Enable/disable PGA2 mute for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param value - valid values are AD1777_PGA_UNMUTE, AD1777_PGA_MUTE
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_pga_mute_2(uint8_t chip_addr, ad1777_pga_mute_t value);

//*****************************************************************************
//
//! @brief Enable/disable PGA3 mute for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param value - valid values are AD1777_PGA_UNMUTE, AD1777_PGA_MUTE
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_pga_mute_3(uint8_t chip_addr, ad1777_pga_mute_t value);

//*****************************************************************************
//
//! @brief Select line or microphone input for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param value - valid values are AD1777_PGA_POWER_DOWN, AD1777_PGA_POWER_UP
//! AIN2 used as a single-ended line input. AD1777_PGA_POWER_DOWN.
//! AIN2 used as a single-ended microphone input. AD1777_PGA_POWER_UP.
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_pga_en_2(uint8_t chip_addr, ad1777_pga_en_t value);
...
//!
//! @param value - valid values are AD1777_PGA_POWER_DOWN, AD1777_PGA_POWER_UP
//! AIN3 used as a single-ended line input. AD1777_PGA_POWER_DOWN.
//! AIN3 used as a single-ended microphone input. AD1777_PGA_POWER_UP.
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_pga_en_3(uint8_t chip_addr, ad1777_pga_en_t value);

//*****************************************************************************
//
//! @brief Enable/disable MIC Bias0 output for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param value - valid values are AD1777_MIC_BIAS_DISA, AD1777_MIC_BIAS_EN
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_mic_bias_en_0(uint8_t chip_addr, ad1777_mic_bias_t value);

//*****************************************************************************
//
//! @brief Enable/disable MIC Bias1 output for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param value - valid values are AD1777_MIC_BIAS_DISA, AD1777_MIC_BIAS_EN
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_mic_bias_en_1(uint8_t chip_addr, ad1777_mic_bias_t value);

//*****************************************************************************
//
//! @brief Set the gain of PGA2 for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param gain - valid values are 0x00 to 0x3F, where 0x00 is -12dB and 0x3F is 35.25dB.
//! Each step represents an increase of 0.75dB.
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_pga_gain_2(uint8_t chip_addr, uint16_t gain);

//*****************************************************************************
//
//! @brief Set the gain of PGA3 for ADAU1777
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param gain - valid values are 0x00 to 0x3F, where 0x00 is -12dB and 0x3F is 35.25dB.
...
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_pga_gain_3(uint8_t chip_addr, uint16_t gain);

//*****************************************************************************
//
//! @brief Set linear gain for ADAU1777 using pre-calculated gain table
//!
//! @param chip_addr - Chip I2C device address.
//!
//! @param value - valid values are 0 to 15, representing 0dB to 15dB gain.
//! Each value corresponds to a pre-calculated linear gain value in 5.23 format.
//!
//! @return status - Generic or interface specific status.
//
//*****************************************************************************
extern uint32_t am_devices_adau1777_set_linear_gain(uint8_t chip_addr, uint8_t value);
