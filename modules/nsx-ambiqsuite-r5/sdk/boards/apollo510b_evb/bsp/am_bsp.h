...
//!
//! @addtogroup Apollo510B Evaluation Board BSP Board Support Package (BSP)
//! @ingroup BSP
//! @{
//
//*****************************************************************************
...
#define AM_BSP_IS_SIP
// Needed for EM9305 init, includes 255 maximum HCI command + 4 HCI header
#define AM_BSP_HCI_DRV_MAX_TX_PACKET            259
...
// ios_controller
//
#define TEST_IOS_CNTLR_MODULE           7
#define am_iomaster_isr                 am_iomaster7_isr
#define IOMSTR_IQRn                     IOMSTR7_IRQn

//
// ios_fullduplex
//
#define IOM_DUPLEX_TEST_MODULE      7

//
// ios_fullduplex/ios_fullduplex_host
//
#define AM_BSP_GPIO_TEST_IOM_SCK        AM_BSP_GPIO_IOM7_SCK
#define AM_BSP_GPIO_TEST_IOM_MOSI       AM_BSP_GPIO_IOM7_MOSI
#define AM_BSP_GPIO_TEST_IOM_MISO       AM_BSP_GPIO_IOM7_MISO
#define AM_BSP_GPIO_TEST_IOM_CE         AM_BSP_GPIO_IOM7_CS
...
//
//*****************************************************************************
#define AM_BSP_UART_PRINT_INST  1   // UART COM module
...
#endif
#define AM_BSP_BUTTON0_IRQ                  GPIO0_203F_IRQn
#define am_bsp_button0_isr                  am_gpio0_203f_isr
#define AM_BSP_BUTTON1_IRQ                  GPIO0_001F_IRQn
#define am_bsp_button1_isr                  am_gpio0_001f_isr
...
//*****************************************************************************
//
//! @brief Enable the IOM pins based on mode and module.
//!
//! @param ui32Module - IOM module
//! @param ui32IOSMode - IOM mode of the device
//
//*****************************************************************************
...
//*****************************************************************************
//
//! @brief Enable the IOS pins based on mode and module.
//!
//! @param ui32Module - IOS module
