...
//! @addtogroup apollo510dL_evb BSP
//! @ingroup BSP
//! @{
//
//*****************************************************************************
...
#define AM_BSP_BUTTON0_IRQ                  GPIO0_001F_IRQn
#define am_bsp_button0_isr                  am_gpio0_001f_isr
#define AM_BSP_BUTTON1_IRQ                  GPIO0_203F_IRQn
#define am_bsp_button1_isr                  am_gpio0_203f_isr
#endif
...
#define IOM_HANDSHAKE_PIN               16
#define IOM_HANDSHAKE_PIN_IRQ           GPIO0_001F_IRQn
#define IOM_HANDSHAKE_PIN_ISR           am_gpio0_001f_isr
...
// #### INTERNAL BEGIN ####
#if 0 // Not needed for Apollo510 and later. CAYNSWS-1513
//*****************************************************************************
//
