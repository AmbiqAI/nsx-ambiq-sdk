/**
 * @brief Atomiq110 staged power-profile dump helpers.
 */
...
static const nsx_power_profile_reg_t s_nsx_power_profile_regs[] = {
    ...
    {&PWRCTRL->DEVPWREN1, "PWRCTRL.DEVPWREN1", "Peripheral power enable mask, bank 1."},
    {&PWRCTRL->DEVPWRSTATUS0, "PWRCTRL.DEVPWRSTATUS0", "Peripheral power status mask, bank 0."},
    {&PWRCTRL->DEVPWRSTATUS1, "PWRCTRL.DEVPWRSTATUS1", "Peripheral power status mask, bank 1."},
