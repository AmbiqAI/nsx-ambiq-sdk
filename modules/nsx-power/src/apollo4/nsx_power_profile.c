/**
 * @brief Apollo4 staged power-profile dump helpers.
 */
...
static const nsx_power_profile_reg_t s_nsx_power_profile_regs[] = {
    ...
    {&PWRCTRL->AUDSSPWRSTATUS, "PWRCTRL.AUDSSPWRSTATUS", "Audio subsystem power status."},
    ...
    {&PWRCTRL->ADCSTATUS, "PWRCTRL.ADCSTATUS", "ADC power status."},
    {&PWRCTRL->AUDADCSTATUS, "PWRCTRL.AUDADCSTATUS", "Audio ADC power status."},
