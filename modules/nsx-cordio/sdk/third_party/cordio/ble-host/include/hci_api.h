...
typedef struct
{
  wsfMsgHdr_t        hdr;                                               /*!< \brief Event header. */
  uint16_t           opcode;                                            /*!< \brief Opcode. */
  uint8_t            param[HCI_EVT_VENDOR_SPEC_CMD_CMPL_PARAM_MAX_LEN]; /*!< \brief Operation parameter. */
...
{
  wsfMsgHdr_t        hdr;                                          /*!< \brief Event header. */
  uint8_t            param[HCI_EVT_VENDOR_SPEC_EVT_PARAM_MAX_LEN]; /*!< \brief Vendor specific event. */
} hciVendorSpecEvt_t;
...
typedef union
{
  ...
  hciLePerAdvRspReportEvt_t           lePerAdvRspReport;           /*!< \brief LE Periodic Advertising Response Report. */
#endif // BT_54
} hciEvt_t;
