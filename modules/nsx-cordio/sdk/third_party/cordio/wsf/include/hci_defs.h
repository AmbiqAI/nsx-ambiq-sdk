...
/* Version 5.3  */
#define HCI_LE_SUP_FEAT_PRR_ADV_ADI                  0x0000001000000000  /*!< Periodic Advertising ADI support */
#define HCI_LE_SUP_FEAT_SUBRATING                    0x0000002000000000  /*!< Connection Subrating */
#define HCI_LE_SUP_FEAT_SUBRATING_HOST_SUPPORT       0x0000004000000000  /*!< Connection Subrating (Host Support) */
#define HCI_LE_SUP_FEAT_CHAN_CLASSIFICATION          0x0000008000000000  /*!< Channel Classification */
/* Version 5.4  */
...
// Define the minimal connection interval to 2 when configured 2.5ms feature
#define HCI_CONN_INTERVAL_MIN                        0x0002  /*!< \brief Minimum connection interval for 2.5ms connection interval*/
#define HCI_CONN_INTERVAL_7P5MS                      0x0006  /*!< \brief 7.5ms connection interval*/
#else
// #### INTERNAL END ####
