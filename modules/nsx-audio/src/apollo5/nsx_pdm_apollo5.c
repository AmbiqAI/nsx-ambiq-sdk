/**
 * @file nsx_pdm_apollo5.c
 * @brief PDM driver for Apollo5 family (Apollo5B, Apollo510, Apollo510B).
 *
 * Migrated from legacy ns-audio/src/apollo5/nsx_pdm.c with the following fixes:
...
/* PDM IRQ table — PDM0 always present, PDM1-3 gated by NSX_PDM1TO3_PRESENT. */
#ifdef NSX_PDM1TO3_PRESENT
...
const nsx_audio_pdm_config_t nsx_audio_pdm_default = {
    ...
    .left_gain    = NSX_AUDIO_PDM_GAIN_P180DB,
    .right_gain   = NSX_AUDIO_PDM_GAIN_P180DB,
};
...
uint32_t nsx_audio_init(nsx_audio_config_t *cfg) {
    ...
    case NSX_AUDIO_CLK_HFRC2_ADJ:
        ...
        return NSX_STATUS_INVALID_CONFIG;  /* not supported on these parts */
#else
