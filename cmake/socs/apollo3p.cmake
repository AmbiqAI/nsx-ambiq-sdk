...
if(NOT NSX_SDK_PROVIDER STREQUAL "ambiqsuite-r3")
    message(FATAL_ERROR
        "apollo3p requires NSX_SDK_PROVIDER=ambiqsuite-r3, got '${NSX_SDK_PROVIDER}'."
    )
endif()
...
set(NSX_SOC_FLAGS_TARGET_EXPORT_NAME "soc_flags_apollo3p")
...
if(NOT TARGET nsx::soc_apollo3p)
    add_library(nsx::soc_apollo3p ALIAS ${NSX_SOC_TARGET})
endif()
