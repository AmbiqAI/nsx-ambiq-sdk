...
include("${CMAKE_CURRENT_LIST_DIR}/_facts/apollo5b.cmake")

if(NOT NSX_SDK_PROVIDER STREQUAL "ambiqsuite-r5")
    message(FATAL_ERROR
        "apollo5b requires NSX_SDK_PROVIDER=ambiqsuite-r5, got '${NSX_SDK_PROVIDER}'."
    )
endif()
...
set(NSX_SOC_TARGET nsx_soc_apollo5b)
set(NSX_SOC_FLAGS_TARGET nsx_soc_apollo5b_flags)
set(NSX_SOC_DESCRIPTOR_TARGET_EXPORT_NAME "soc_apollo5b")
set(NSX_SOC_FLAGS_TARGET_EXPORT_NAME "soc_flags_apollo5b")
...
if(NOT TARGET nsx::soc_apollo5b)
    add_library(nsx::soc_apollo5b ALIAS ${NSX_SOC_TARGET})
endif()
