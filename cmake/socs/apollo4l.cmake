...
include("${CMAKE_CURRENT_LIST_DIR}/_facts/apollo4l.cmake")

if(NOT NSX_SDK_PROVIDER STREQUAL "ambiqsuite-r4")
    message(FATAL_ERROR
        "apollo4l requires NSX_SDK_PROVIDER=ambiqsuite-r4, got '${NSX_SDK_PROVIDER}'."
    )
endif()
...
if(NOT TARGET ${NSX_SOC_FLAGS_TARGET})
    ...
    target_compile_definitions(${NSX_SOC_FLAGS_TARGET} INTERFACE
        $<$<COMPILE_LANGUAGE:C>:PART_apollo4l>
        $<$<COMPILE_LANGUAGE:C>:AM_PART_APOLLO4L>
