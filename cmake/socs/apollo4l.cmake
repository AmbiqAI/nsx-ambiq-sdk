...
include("${CMAKE_CURRENT_LIST_DIR}/facts/apollo4l.cmake")

if(NOT NSX_SDK_PROVIDER STREQUAL "ambiqsuite")
    message(FATAL_ERROR
        "apollo4l requires NSX_SDK_PROVIDER=ambiqsuite, got '${NSX_SDK_PROVIDER}'."
    )
endif()
...
if(NSX_TOOLCHAIN_IS_ARMCLANG)
    set(NSX_STARTUP_SOURCE "${NSX_ROOT}/modules/nsx-core/src/apollo4l/armclang/startup_keil6.c")
...
set(NSX_SOC_TARGET nsx_soc_apollo4l)
set(NSX_SOC_FLAGS_TARGET nsx_soc_apollo4l_flags)
set(NSX_SOC_DESCRIPTOR_TARGET_EXPORT_NAME "soc_apollo4l")
set(NSX_SOC_FLAGS_TARGET_EXPORT_NAME "soc_flags_apollo4l")
...
if(NOT TARGET nsx::soc_apollo4l)
    add_library(nsx::soc_apollo4l ALIAS ${NSX_SOC_TARGET})
endif()
